...
int main()
{
	...
	std::uniform_int_distribution<int> indexX = std::uniform_int_distribution<int>(20, 260);
	std::uniform_int_distribution<int> indexY = std::uniform_int_distribution<int>(20, 190);

	for (unsigned int i = 0, r, c; i < 10; i++) {

		r = indexX(gen);
		c = indexY(gen);

		CELL_GRID[r][c]->NEIGHBORS[0]->spark();
		CELL_GRID[r][c]->NEIGHBORS[0]->turnOn();
		CELL_GRID[r][c]->NEIGHBORS[1]->spark();
		CELL_GRID[r][c]->NEIGHBORS[1]->turnOn();
		CELL_GRID[r][c]->NEIGHBORS[2]->spark();
		CELL_GRID[r][c]->NEIGHBORS[2]->turnOn();
		CELL_GRID[r][c]->NEIGHBORS[3]->spark();
		CELL_GRID[r][c]->NEIGHBORS[3]->turnOn();
		CELL_GRID[r][c]->NEIGHBORS[4]->spark();
		CELL_GRID[r][c]->NEIGHBORS[4]->turnOn();
		CELL_GRID[r][c]->NEIGHBORS[5]->spark();
		CELL_GRID[r][c]->NEIGHBORS[5]->turnOn();
